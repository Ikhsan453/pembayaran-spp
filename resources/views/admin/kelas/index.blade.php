                ...
                <div class="card-body">
                 <table class="table table-striped table-hover">
                  ...
                  <div class="d-flex justify-content-between align-items-center btn btn-sm">
                      <div>
                          Showing <b>{{ $kelas->firstItem() }}</b> to <b>{{ $kelas->lastItem() }}</b> of <b>{{ $kelas->total() }}</b> results
                      </div>
                      <div>
                          {{ $kelas->links() }}
                      </div>
        ...
        <div class="modal-body">
          <form action="{{ route('kelas.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              is-invalid
              @enderror" name="kompetensi_keahlian" placeholder="Masukkan Kompetensi Keahlian Dengan Benar">
        ...
        <div class="modal-body">
          <form action="{{ route('kelas.update',$k->id) }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('kompetensi_keahlian')
              is-invalid
              @enderror" name="kompetensi_keahlian" value="{{old('kompetensi_keahlian', $k->kompetensi_keahlian)}}" placeholder="Masukkan Kompetensi Keahlian Dengan Benar">
                @error('kompetensi_keahlian')
                <div class="alert alert-danger" role="alert">
                  {{ $message }}
                </div>
